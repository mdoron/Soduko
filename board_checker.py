...
class BoardChecker:
    ...
    def check_all_inlays(self):
        return reduce(lambda x, y: x and y,
                      map(self.check_area, [0, 0, 0, SQUARE_SIZE, SQUARE_SIZE, SQUARE_SIZE, 6, 6, 6],
    ...
    def check_diff(self, x, y):
        ...
        return self.check_col(y) and self.check_row(x) and self.check_area(int(x / SQUARE_SIZE) * SQUARE_SIZE,
